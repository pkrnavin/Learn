...
-- LearnUI DB-Fix before verification 

-- below to add, of before verfication start 
SELECT 'DB-Fix Before Verification 1.001 Part 1; Start';
...
-- below to add, of before verfication complete 
SELECT 'DB-Fix Before Verification 1.001 Part 1; Complete';
